...
> 
> **Note on compress skill:** If you are modifying the compress skill, edit `skills/caveman-compress/SKILL.md` or `skills/caveman-compress/scripts/`. CI will automatically sync these changes to `plugins/caveman/skills/caveman-compress/`.
